...
const Home: NextPage = () => {
	...
	const handleSignIn = async (e: React.FormEvent) => {
		...
		if (error) {
			alert(
				JSON.stringify(
					'Hibás e-mail cím vagy jelszó. Próbálja újra, vagy kattintson az Elfelejtett jelszó linkre a jelszó visszaállításához.',
				),
			);
		}
	};
				...
				>
					<Grid>
						<FormControl onSubmit={handleSignIn}>
							<TextField
								sx={{ padding: '0px', width: '300px', margin: '20px', '& label': { color: '#052029' } }}
								id='email'
								label='E-mail cím'
							...
							<Box sx={{ padding: '0px', width: '300px', margin: '20px', marginTop: '0px' }}>
								<Link href='/resetpassword' underline='none' sx={{ marginRight: '75px' }}>
									Elfelejtett jelszó
								</Link>
